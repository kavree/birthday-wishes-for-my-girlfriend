  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          สุขสันต์วันเกิดนะคะที่รัก! 🎉<br />
          ขอบคุณที่โลกนี้มีเธอเข้ามา เติมเต็มทุกวันให้มีความหมาย ขอให้ปีนี้เป็นปีที่พิเศษที่สุด มีแต่รอยยิ้ม เสียงหัวเราะ และความรักของเราที่เบ่งบานยิ่งขึ้นไปอีกนะ ❤️
        </motion.p>
      </div>
    </motion.header>
  );
